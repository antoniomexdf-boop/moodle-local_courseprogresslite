...
/**
 * English language strings for local_courseprogresslite.
 *
...
$string['pluginname'] = 'Course Progress Lite';
...
$string['settingsenabled_desc'] = 'If disabled, the progress bar is not shown to students.';
...
$string['noactivitiesdetected'] = 'No visible completion-enabled activities were detected in this course.';
$string['privacy:metadata'] = 'The local_courseprogresslite plugin does not store personal data.';
